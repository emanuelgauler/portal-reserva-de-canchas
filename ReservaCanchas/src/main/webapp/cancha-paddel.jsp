...
<body>
    <div  class="container">
        <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            <a href="./index.jsp" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark text-decoration-none">
                <img src="/Reserva_Canchas/images/LogoPuntoFutbol.247x32.png" alt="Logo">
            </a>

            <ul class="nav nav-pills">
                <li class="nav-item"><a href="./cancha-futbol.jsp" class="nav-link" style="color: green;">Fútbol</a></li>
    ...
    <main class="container border border-1">
        <div id="paddle_grid" class="row row-col-auto g-2 justify-content-between">
            <!--
                ...
                <div id="football_img_slider_0" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner" style="height: 12rem;">
                        <div class="carousel-item active">
                            <img class="img-fluid" src="./ImagenesHome/PaddleCemento.jpg" alt="Paddle Cemento">
                        </div>
            ...
            <div class="col-4 card">
                <div id="football_img_slider_1" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner" style="height: 12rem;">
                        <div class="carousel-item active">
                            <img src="./ImagenesHome/PaddleCesped.jpg" alt="Paddle Césped">
                        </div>
                        <div class="carousel-item">
                            <img src="./ImagenesHome/PaddleCesped2.jpg" alt="Paddle Césped">
                        </div>
                    </div>
                    <button class="carousel-control-prev" type="button" data-bs-target="#football_img_slider_1" data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#football_img_slider_1" data-bs-slide="next">
                        <span class="carousel-control-next-icon" aria-hidden="true"></span>
                    </button>
                </div>
                <div class="card-body">
                    <h3 class="card-title">Cancha Césped y Caucho</h3>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Tipo de cancha: Media</li>
                        <li class="list-group-item">Medidas de la cancha:</li>
                        <li class="list-group-item">Precio de la reserva:</li>
                    </ul>
                    <div class="card-footer">
            ...
            <div class="col-4 card">
                <div id="football_img_slider_2" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner" style="height: 12rem;">
                        <div class="carousel-item active">
                            <img src="./ImagenesHome/PaddleArena.jpg" alt="Fútbol 5">
                        </div>
                        <div class="carousel-item">
                            <img src="./ImagenesHome/PaddleArena2.jpg" alt="Fútbol 5">
                        </div>
                    </div>
                    <button class="carousel-control-prev" type="button" data-bs-target="#football_img_slider_2" data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#football_img_slider_2" data-bs-slide="next">
                        <span class="carousel-control-next-icon" aria-hidden="true"></span>
                    </button>
                </div>
                <div class="card-body">
                    <h3 class="card-title">Cancha Césped y Arena</h3>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Tipo de cancha: Lenta</li>
                        <li class="list-group-item">Medidas de la cancha:</li>
                        <li class="list-group-item">Precio de la reserva:</li>
                    </ul>
                    <div class="card-footer">
