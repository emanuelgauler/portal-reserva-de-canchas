...
var soccer_fields = [
   {
      "imgs": [
         { "path": "/Reserva_Canchas/images/futbol5_2.jpg", "desc": "Futbol 1" }
         , { "path": "/Reserva_Canchas/images/futbol5.jpg", "desc": "Futbol 2" }
      ],
   ...
   {
      "imgs": [
         { "path": "/Reserva_Canchas/images/futsal.jpg", "desc": "Futsal 1" }
         , { "path": "/Reserva_Canchas/images/futsal2.jpg", "desc": "Futsal 2" }
      ],
      tipo_de_cancha: "Piso",
      cantidad_por_equipo: 5,
      precio: 2000,
   ...
   {
      "imgs": [
         { "path": "/Reserva_Canchas/images/futsal3.jpg", "desc": "Futsal 3" }
         , { "path": "/Reserva_Canchas/images/futsal4.jpg", "desc": "Futsal 4" }
      ],
      tipo_de_cancha: "Piso",
