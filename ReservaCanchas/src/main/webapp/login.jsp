...
<head>
    ...
    <link rel="stylesheet" href="/Reserva_Canchas/css/StyleLogin.css">
    <link rel="stylesheet" type="text/css" href="/Reserva_Canchas/css/bootstrap-icons.css">
</head>
<body >
        <form class="row g-3 p-5 d-flex justify-content-center text-secondary">
    <div class="margin-form rounded-5 p-5">
        <div class="container">
        <div class="row justify-content-center">
            <div class="col-3">
            <img src="/Reserva_Canchas/images/loginFutbol.png" alt ="login-icon" class = "img-logo-login"/>
            </div>          
          </div> 
        </div> 
          <div class="row">
       ...
       <div class="row"> 
        <div class="col">
            <div class="input-group flex-nowrap">                
                ...
                <input type="text" class="form-control" placeholder="Contraseña" aria-label="Password" aria-describedby="addon-wrapping">
              </div>
          </div>
       </div>
       <div class="row"> 
       ...
       <div class="row"> 
        <div class="col">
            <button type="button" class="btn btn-outline-dark w-100 mt-3">Login</button>
          </div>
       </div>
       <div class="row"> 
